...
:hb-pdf: https://link.springer.com/content/pdf/10.1007/978-3-031-06739-6.pdf
...
ifndef::pdf-backend[]
//------------------------------------ Badges --------
//image:https://requirements.university//workflows/Check%20Markdown%20links/badge.svg[Check Markdown links,link="https://requirements.university//actions"]
